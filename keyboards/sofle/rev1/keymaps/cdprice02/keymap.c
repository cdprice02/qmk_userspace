...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_NUMBERS] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
    ...
    [_FUNCTIONS] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
    // clang-format on
};
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_DEFAULT] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, KC_TAB, LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN), KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_MPLY, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LGUI, XXXXXXX, KC_ESC, LT(_NAVIGATION, KC_SPC), LT(_FUNCTIONS, KC_TAB), LT(_SYMBOLS, KC_ENT), LT(_NUMBERS, KC_SPC), KC_DEL, XXXXXXX, KC_RGUI),
    /*
     * NAVIGATION
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Esc  |      |NextWd|      |      |      |                    | Copy | Undo |      |      | Paste| Bspc |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Tab  | LGui | LAlt | LCtl |LShift|      |-------.    ,-------| Left | Down |  Up  | Right|      |      |
     * |------+------+------+------+------+------|  Mute |    | Pause |------+------+------+------+------+------|
     * |LShift|      | Cut  |      |      |PrevWd|-------|    |-------|      |      |      |      |      |RShift|
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LGui |      | Esc  | Space| / Tab   /       \Enter \  | Space| Del  |      | RGui |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    [_NAVIGATION] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, KC_NXTWD, XXXXXXX, XXXXXXX, XXXXXXX, KC_COPY, KC_UNDO, XXXXXXX, XXXXXXX, KC_PSTE, _______, _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, XXXXXXX, _______, XXXXXXX, KC_CUT, XXXXXXX, XXXXXXX, KC_PRVWD, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    /*
     * FUNCTIONS
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Esc  |      |      |      |      |      |                    |NumLck|  F1  |  F2  |  F3  |  F4  | Bspc |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Tab  | LGui | LAlt | LCtl |LShift|      |-------.    ,-------|CapLck|  F5  |  F6  |  F7  |  F8  |      |
     * |------+------+------+------+------+------|  Mute |    | Pause |------+------+------+------+------+------|
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_FUNCTIONS] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LNUM, KC_F1, KC_F2, KC_F3, KC_F4, _______, _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, KC_LCAP, KC_F5, KC_F6, KC_F7, KC_F8, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, KC_LSCR, KC_F9, KC_F10, KC_F11, KC_F12, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    /*
     * SYMBOLS
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
     ...
     * | Esc  |      |   7  |   8  |   9  |   -  |                    |      |      |      |      |      | Bspc |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Tab  |      |   4  |   5  |   6  |   =  |-------.    ,-------|      |RShift| RCtl | RAlt | RGui |      |
     * |------+------+------+------+------+------|  Mute |    | Pause |------+------+------+------+------+------|
     * |LShift|      |   1  |   2  |   3  |   \  |-------|    |-------|      |      |   ,  |   .  |   /  |RShift|
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LGui |      | Esc  | Space| / Tab   /       \Enter \  | Space| Del  |      | RGui |
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_NUMBERS] = LAYOUT(_______, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______, XXXXXXX, KC_7, KC_8, KC_9, KC_MINS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, KC_4, KC_5, KC_6, KC_EQL, XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, XXXXXXX, _______, XXXXXXX, KC_1, KC_2, KC_3, KC_BSLS, _______, _______, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, LT(_NAVIGATION, KC_0), _______, _______, _______, _______, _______, _______),
};
